...
public class CraftTrackerTrackCombatDropFilter : BooleanFilter
{
    ...
    public override string Name { get; set; } = LocalizationService.Ui(LocalizationService.Ui("Track Combat Drops?"));
    
    public override string HelpText { get; set; } =
        LocalizationService.Ui(LocalizationService.Ui("When you are in combat and an item drops and it matches one of the output items in this craft list, should it reduce the quantity of that item? The craft list must be active for this to count."));
