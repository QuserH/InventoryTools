...
public class CraftHouseVendorFilter : ChoiceFilter<HouseVendorSetting>
{
    ...
    public override string Name { get; set; } = LocalizationService.Ui(LocalizationService.Ui("Group House Vendors By"));

    public override string HelpText { get; set; } =
        LocalizationService.Ui(LocalizationService.Ui("How should house vendor items be grouped?"));
