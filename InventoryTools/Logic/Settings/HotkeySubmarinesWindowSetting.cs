...
namespace InventoryTools.Logic.Settings
{
    public class HotkeySubmarinesWindowSetting : HotKeySetting
    {
        ...
        public override string Name { get; set; } = LocalizationService.Ui(LocalizationService.Ui("Toggle Submarines Window"));

        public override string HelpText { get; set; } =
            LocalizationService.Ui(LocalizationService.Ui("The hotkey to toggle the submarines window."));
