...
namespace InventoryTools.Logic.Columns
{
    public class RarityColumn : TextColumn
    {
        ...
        public override string Name { get; set; } = LocalizationService.Ui("Rarity");
        public override float Width { get; set; } = 70.0f;
        public override string HelpText { get; set; } = LocalizationService.Ui(LocalizationService.Ui("The item's rarity."));
