...
namespace InventoryTools.Logic.Columns
{
    public class SellToVendorPriceTotalColumn : GilColumn
    {
        ...
        public override string Name { get; set; } = LocalizationService.Ui(LocalizationService.Ui("Sell to Vendor Price (Total)"));
        public override float Width { get; set; } = 100.0f;
        public override string HelpText { get; set; } = LocalizationService.Ui(LocalizationService.Ui("The total amount this item can be sold to a vendor for in gil(price * quantity)."));
